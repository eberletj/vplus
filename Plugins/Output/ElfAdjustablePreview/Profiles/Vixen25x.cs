...
namespace ElfAdjustablePreview.Profiles {
    ...
    public class Vixen25x : BaseVixen, IProfile {
        ...
        protected override ElfRawChannel LoadChannelFromXml(XmlNode node) {
            ElfRawChannel Channel = base.LoadChannelFromXml(node);
        ...
        /// </summary>
        protected override void SaveChannelName(XmlNode node, ElfRawChannel channel) {
