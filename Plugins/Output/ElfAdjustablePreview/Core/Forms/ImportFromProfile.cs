	...
	public partial class ImportFromProfile : Form
	{
		...
		public string Filename
		{
			set
			{
				...
				foreach (ElfChannel Channel in _importProfile.Channels.List)
				{
		...
		public ImportFromProfile()
		{
			...
			foreach (ElfChannel Channel in Profile.Channels.List)
			{
		...
		private void PopulateMapFromControls(Mapping map)
		{
			...
			{
				Channel = (ElfChannel)_listBoxUtil.GetTag(lstImportedChannels);
		...
		private void lstImportedChannels_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				_editMap.ImportedChannel = (ElfChannel)((ImageListItem)lstImportedChannels.Items[lstImportedChannels.SelectedIndex]).Tag;
