...
namespace ElfAdjustablePreview.Core.Forms
{
	partial class EditShuffle
	{
		...
		private void InitializeComponent()
		{
			...
			this.lstSorted = new ImageListBox();
			this.lstUnsorted = new ImageListBox();
			this.SuspendLayout();
			// 
			// _txtName
			// 
			...
			// cmdAdd
			// 
			this.cmdAdd.Image = global::ElfAdjustablePreview.Properties.Resources.right;
			...
			// cmdRemove
			// 
			this.cmdRemove.Image = global::ElfAdjustablePreview.Properties.Resources.left;
		...
		private ImageListBox lstSorted;
		private ImageListBox lstUnsorted;
	}
}