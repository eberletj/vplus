...
namespace ElfAdjustablePreview.Core.Forms
{
	public partial class NewProfile : Form
	{
		...
		{
			_channels.Remove((ElfChannel)((ImageListItem)(lstChannels.Items[index])).Tag);
		...
		{
			ElfChannel Channel = new ElfChannel();
			Channel.ID = _nextID++;
		...
		private void cmdEdit_Click(object sender, EventArgs e)
		{
			...
			ElfChannel Channel = (ElfChannel)((ImageListItem)(lstChannels.SelectedItem)).Tag;
