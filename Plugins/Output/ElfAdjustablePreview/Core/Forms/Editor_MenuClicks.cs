...
namespace ElfAdjustablePreview.Core.Forms
{
	partial class Editor
	{
		...
		internal void Channel_AddNew_Click(object sender, EventArgs e)
		{
			...
			ElfChannel NewChannel = new ElfChannel();
		...
		internal void Channel_Delete_Click(object sender, EventArgs e)
		{
			...
			foreach (ElfChannel Channel in Profile.Channels.Selected)
		...
		internal void Channel_Import_Click(object sender, EventArgs e)
		{
			...
			ElfChannel ImportChannel = null;

			if (!frmImport.MaxSetBack.IsEmpty)
			{ 
				foreach(ElfChannel Channel in Profile.Channels)
		...
		{
			ElfChannel Channel = Profile.Channels.Active;
