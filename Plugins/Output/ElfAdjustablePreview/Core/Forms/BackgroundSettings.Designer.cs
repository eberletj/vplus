...
namespace ElfAdjustablePreview.Core.Forms
{
	partial class BackgroundSettings
	{
		...
		private void InitializeComponent()
		{
			...
			ColorManager.HSL hsl1 = new ColorManager.HSL();
			...
			ColorManager.HSL hsl2 = new ColorManager.HSL();
			...
			this.hslBrightness = new HSLSlider();
			this.hslSaturation = new HSLSlider();
			this.hslHue = new HSLSlider();
			this.cmdSaveModified = new System.Windows.Forms.Button();
			this.cddGrid = new ColorDropDown();
			this.cddBackground = new ColorDropDown();
			...
			this.cboPicturePosition = new ImageDropDown();
			this.cboAnchor = new ImageDropDown();
			...
			this.hslBrightness.DrawStyle = HSLSlider.eDrawStyle.Luminance;
			hsl1.Alpha = 1D;
			hsl1.H = 0D;
			hsl1.Hue = 0D;
			hsl1.L = 0D;
			...
			this.hslSaturation.DrawStyle = HSLSlider.eDrawStyle.Saturation;
			hsl2.Alpha = 1D;
			hsl2.H = 0D;
			hsl2.Hue = 0D;
			hsl2.L = 1D;
			...
			this.hslHue.DrawStyle = HSLSlider.eDrawStyle.HueOffset;
			hsl3.Alpha = 1D;
			hsl3.H = 0D;
			hsl3.Hue = 0D;
			hsl3.L = 1D;
			...
			this.cmdSaveModified.Image = global::ElfAdjustablePreview.Properties.Resources.annotation_save;
        ...
        "htness sliders.");
			...
			this.cddGrid.CancelButtonImage = global::ElfAdjustablePreview.Properties.Resources.cancel;
			...
			this.cddGrid.OKButtonImage = global::ElfAdjustablePreview.Properties.Resources.check;
        ...
        "ground.");
			...
			this.cddBackground.CancelButtonImage = global::ElfAdjustablePreview.Properties.Resources.cancel;
			...
			this.cddBackground.OKButtonImage = global::ElfAdjustablePreview.Properties.Resources.check;
        ...
        "age used has transparency.");
			...
			this.cmdClear.Image = global::ElfAdjustablePreview.Properties.Resources.background;
			...
			this.cmdSave.Image = global::ElfAdjustablePreview.Properties.Resources.annotation_save;
			...
			this.cmdBrowse.Image = global::ElfAdjustablePreview.Properties.Resources.open;
    ...
    " (*.gif)|*.gif|All Files (*.*)|*.*";
			...
			this.cmdOk.Image = global::ElfAdjustablePreview.Properties.Resources.check;
			...
			this.cmdCancel.Image = global::ElfAdjustablePreview.Properties.Resources.cancel;
			...
			this.cmdReset.Image = global::ElfAdjustablePreview.Properties.Resources.undo;
		...
		private HSLSlider hslBrightness;
		private HSLSlider hslSaturation;
		private System.Windows.Forms.Label _qcBackground;
		private System.Windows.Forms.Label _qcGridColor;
		private ColorDropDown cddGrid;
		private ColorDropDown cddBackground;
		private System.Windows.Forms.Label _cboPicturePosition;
		private ImageDropDown cboPicturePosition;
		...
		private HSLSlider hslHue;
		private ImageDropDown cboAnchor;
