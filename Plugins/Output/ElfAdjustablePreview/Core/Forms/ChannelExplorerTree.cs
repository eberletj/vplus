...
namespace ElfAdjustablePreview.Core.Forms
{
    public partial class ChannelExplorerTree : ToolWindow
    {
        ...
        private void AddColorSwatchIcon(CXTreeNode channelNode)
        {
            ...
            ElfChannel Channel = channelNode.Channel;
        ...
        public void BuildTree(bool rebuild)
        {
            ...
            {
                foreach (ElfChannel Channel in Profile.Channels.Sorted)
                {
        ...
        private CXTreeNode FindTreeNode(ElfChannel channel, TreeNodeCollection nodes)
        {
            if (channel == null)
        ...
        {
            ElfChannel Channel = ((CXTreeNode)e.Node).Channel;
        ...
        private void Profile_ChannelPropertyChanged(object sender, ChannelListEventArgs e)
        {
            ...
            CXTreeNode ChannelNode = null;
            foreach (ElfChannel Channel in e.Channels)
            {
                ...
                {
                    case ElfChannel.Property_RenderColor:
                    case ElfChannel.Property_SequencerColor:
                    case ElfChannel.Property_BorderColor:
                    case ElfChannel.Property_Locked:
                    case ElfChannel.Property_Included:
                    case ElfChannel.Property_Enabled:
                    case ElfChannel.Property_Visible:
                        AddColorSwatchIcon(ChannelNode);
