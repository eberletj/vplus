...
using ElfAdjustablePreview.Core.PlugIn;
...
using Clipboard = ElfAdjustablePreview.Core.Core.Clipboard;
using LatticePoint = System.Drawing.Point;
using LatticePointF = System.Drawing.PointF;
using Stopwatch = ElfAdjustablePreview.Core.Util.Stopwatch;
...
namespace ElfAdjustablePreview.Core.Controllers
{
	public sealed class Workshop : ElfBase
	{
		...
		private List<ElfImageStampChannel> _stampChannels = new List<ElfImageStampChannel>();
		...
		/// </summary>
		public List<ElfImageStampChannel> StampChannels
		{
		...
		public void ExposePane(ElfChannel Channel, Panes pane)
		{
			#if DEBUG
