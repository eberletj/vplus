...
namespace ElfAdjustablePreview.Core.Util
{
	...
	public class ChannelEventArgs : PropertyChangedEventArgs
	{
		...
		public ElfChannel Channel { get; set; }

		#endregion [ Properties ]

		#region [ Constructors ]

		public ChannelEventArgs(ElfChannel channel, string propertyName)
			: base(propertyName)
		{
			Channel = channel;
		}
	...
	public class ChannelListEventArgs : PropertyChangedEventArgs
	{
		...
		public ChannelListEventArgs(ElfChannel channel, string propertyName)
			: base(propertyName)
		{
		...
		public ChannelListEventArgs(ElfChannel channel)
