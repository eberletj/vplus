...
namespace ElfAdjustablePreview.Core.Core
{
	public class Clipboard : ElfDisposable
	{
		...
		public bool HasData
		{
			get
			{
				if (_channels.Count > 0)
					foreach (ElfChannel Ch in _channels)
		...
		protected bool TransferToChannel(ElfChannel sourceChannel, ElfChannel targetChannel, bool useMaskedRegion, bool clearTargetChannel, bool removeCellsFromSource)
		{
